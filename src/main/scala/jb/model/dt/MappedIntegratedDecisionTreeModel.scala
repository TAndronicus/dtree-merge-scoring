...
class MappedIntegratedDecisionTreeModel(val edges: Array[Array[Edge]], val baseModels: Array[DecisionTreeClassificationModel],
                                        val moments: Map[Double, Array[Double]], val distMappingFunction: (Double, Double) => Double) {
